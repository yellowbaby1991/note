...
public class UserDao {
    ...
    public void updateUser(String oldName, String newName) {
        mDb.execSQL("update userinfo set username = ? where username = ?;", new String[]{oldName, newName});
    }

    public User queryUser(String name) {
        Cursor cursor = mDb.rawQuery("select username,phone from userinfo where usename = ?", new String[]{name});
